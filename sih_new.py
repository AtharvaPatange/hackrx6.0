...
class QueryRequest(BaseModel):
    ...
    return_audio: Optional[bool] = Field(False, description="Return audio response URL")
        ...
        for i, chunk in enumerate(chunks):
            if chunk.strip():  # Only include non-empty chunks
                ...
                metadata = {
                    ...
                    "chunk_index": i,
                    "region_meta": req.region_meta or {},
...
Please provide a comprehensive answer based on the context documents above. Include specific details, numbers, and actionable insights where available."""
        ...
        # Add audio URL if requested (placeholder for now)
        if req.return_audio:
            response["audio_url"] = f"https://your-audio-service.com/{query_id}.mp3"
